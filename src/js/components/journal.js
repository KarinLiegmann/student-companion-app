...
function renderPosts(post, index) {
    ...
    journalEntry.innerHTML = `
        <h3> Rating:</h3>
                <div class="journal__starcontainer">${createStars(post.rating)}
...
let star = `< svg width = "25px" height = "24px" viewBox = "0 0 25 24" version = "1.1" xmlns = "http://www.w3.org/2000/svg"
            xmlns: xlink = "http://www.w3.org/1999/xlink" >
                    <title>Star@2x</title>
                    <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Star" fill="#193251">
...
let rectangle = `<svg width="22px" height="22px" viewBox="0 0 22 22" version="1.1" xmlns="http://www.w3.org/2000/svg"
xmlns:xlink="http://www.w3.org/1999/xlink">
